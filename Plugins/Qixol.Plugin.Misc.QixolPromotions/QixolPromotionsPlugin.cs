...
namespace Qixol.Plugin.Misc.Promo
{
    public class PromoPlugin : BasePlugin, IMiscPlugin, IAdminMenuPlugin
    {
        ...
        private void InsertProductAttributeConfigItems()
        {
            ...
            _productAttributeConfigService.Insert(new ProductAttributeConfigItem() { SystemName = ProductAttributeConfigSystemNames.CATEGORY, NameResource = "Admin.Catalog.Products.Categories.Fields.Category", Enabled = true });
