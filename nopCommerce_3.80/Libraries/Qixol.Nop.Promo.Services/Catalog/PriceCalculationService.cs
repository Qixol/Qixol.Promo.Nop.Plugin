...
namespace Qixol.Nop.Promo.Services.Catalog
{
    public partial class PriceCalculationService : global::Nop.Services.Catalog.PriceCalculationService, IPriceCalculationService
    {
        ...
        public override decimal GetFinalPrice(Product product, global::Nop.Core.Domain.Customers.Customer customer, decimal additionalCharge, bool includeDiscounts,
            int quantity, DateTime? rentalStartDate, DateTime? rentalEndDate, out decimal discountAmount, out List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts)
        {
        ...
        public override decimal GetFinalPrice(Product product, global::Nop.Core.Domain.Customers.Customer customer, decimal additionalCharge, bool includeDiscounts,
            int quantity, out decimal discountAmount, out List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts)
        {
            ...
            bool includeDiscounts = true, int quantity = 1)
        {
            ...
            List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts = null;
        ...
        public override decimal GetSubTotal(ShoppingCartItem shoppingCartItem, bool includeDiscounts, out decimal discountAmount,
            out List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts)
        {
            return base.GetSubTotal(shoppingCartItem, false, out discountAmount, out appliedDiscounts);
        }
        ...
        public override decimal GetSubTotal(ShoppingCartItem shoppingCartItem, bool includeDiscounts = false)
        {
            ...
            return GetSubTotal(shoppingCartItem, false, out discountAmount, out appliedDiscounts);
        }
        ...
        public override decimal GetUnitPrice(Product product, global::Nop.Core.Domain.Customers.Customer customer, ShoppingCartType shoppingCartType,
            ...
            out decimal discountAmount, out List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts)
        {
