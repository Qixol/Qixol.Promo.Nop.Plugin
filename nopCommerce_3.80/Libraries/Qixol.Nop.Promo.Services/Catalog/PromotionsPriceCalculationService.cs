...
namespace Qixol.Nop.Promo.Services.Catalog
{
    public partial class PromosPriceCalculationService : global::Nop.Services.Catalog.PriceCalculationService, IPromosPriceCalculationService
    {
            ...
            int quantity, DateTime? rentalStartDate, DateTime? rentalEndDate, out decimal discountAmount, out List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts)
        {
            ...
            discountAmount = 0M;
            appliedDiscounts = new List<global::Nop.Core.Domain.Discounts.Discount>();
            ...
            int quantity = 1)
        {
            ...
            List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts = new List<global::Nop.Core.Domain.Discounts.Discount>();
            ...
            out List<global::Nop.Core.Domain.Discounts.Discount> appliedDiscounts)
        {
            ...
            if (!_promoSettings.Enabled)
                return base.GetSubTotal(shoppingCartItem, includeDiscounts, out discountAmount, out appliedDiscounts);
            ...
            if (discountAmount != decimal.Zero)
            {
                ...
                {
                    global::Nop.Core.Domain.Discounts.Discount appliedDiscount = new global::Nop.Core.Domain.Discounts.Discount()
                    {
