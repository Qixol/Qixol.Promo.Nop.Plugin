...
namespace Qixol.Nop.Promo.Services.Common
{
    public partial class PdfService : global::Nop.Services.Common.PdfService, global::Nop.Services.Common.IPdfService
    {
        ...
        public override void PrintOrdersToPdf(global::System.IO.Stream stream, IList<global::Nop.Core.Domain.Orders.Order> orders, int languageId = 0)
        {
            if (!_promoSettings.Enabled)
            {
                base.PrintOrdersToPdf(stream, orders, languageId);
                return;
            }
