...
namespace Qixol.Nop.Promo.Services.Catalog
{
    public partial class PriceCalculationService : global::Nop.Services.Catalog.PriceCalculationService, IPriceCalculationService
    {
        ...
        {
            return base.GetFinalPrice(product, customer, additionalCharge, false, quantity, rentalStartDate, rentalEndDate, out discountAmount, out appliedDiscount);
        }
        ...
        {
            return base.GetSubTotal(shoppingCartItem, false, out discountAmount, out appliedDiscount);
        }

        public override decimal GetSubTotal(ShoppingCartItem shoppingCartItem, bool includeDiscounts = false)
        {
            decimal discountAmount;
            global::Nop.Core.Domain.Discounts.Discount appliedDiscount;
            return GetSubTotal(shoppingCartItem, false, out discountAmount, out appliedDiscount);
        }
        ...
        public override decimal GetUnitPrice(Product product, global::Nop.Core.Domain.Customers.Customer customer, ShoppingCartType shoppingCartType, int quantity, string attributesXml, decimal customerEnteredPrice, DateTime? rentalStartDate, DateTime? rentalEndDate, bool includeDiscounts, out decimal discountAmount, out global::Nop.Core.Domain.Discounts.Discount appliedDiscount)
        {
            return base.GetUnitPrice(product, customer, shoppingCartType, quantity, attributesXml, customerEnteredPrice, rentalStartDate, rentalEndDate, false, out discountAmount, out appliedDiscount);
        }

        public override decimal GetUnitPrice(ShoppingCartItem shoppingCartItem, bool includeDiscounts, out decimal discountAmount, out global::Nop.Core.Domain.Discounts.Discount appliedDiscount)
        {
        ...
        public override decimal GetUnitPrice(ShoppingCartItem shoppingCartItem, bool includeDiscounts = false)
        {
            decimal discountAmount = 0M;
            global::Nop.Core.Domain.Discounts.Discount appliedDiscount;
            return GetUnitPrice(shoppingCartItem, false, out discountAmount, out appliedDiscount);
        }
