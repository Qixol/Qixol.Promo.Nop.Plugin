...
namespace Qixol.Nop.Promo.Services.Orders
{
    public partial class OrderTotalCalculationService : global::Nop.Services.Orders.OrderTotalCalculationService, IOrderTotalCalculationService
    {
        ...
        public override void GetShoppingCartSubTotal(IList<global::Nop.Core.Domain.Orders.ShoppingCartItem> cart, bool includingTax, out decimal discountAmount, out global::Nop.Core.Domain.Discounts.Discount appliedDiscount, out decimal subTotalWithoutDiscount, out decimal subTotalWithDiscount)
        {
            SortedDictionary<decimal, decimal> taxRates = new SortedDictionary<decimal, decimal>();
            GetShoppingCartSubTotal(cart, includingTax, out discountAmount, out appliedDiscount, out subTotalWithoutDiscount, out subTotalWithDiscount, out taxRates);
        }
        ...
        public override bool IsFreeShipping(IList<ShoppingCartItem> cart)
        {
            if (!_promoSettings.Enabled)
